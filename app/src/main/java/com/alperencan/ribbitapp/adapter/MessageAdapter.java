package com.alperencan.ribbitapp.adapter;
...
/**
 * Created by pvdispvd on 12/10/14.
 */
public class MessageAdapter extends ArrayAdapter<ParseObject> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (message.getString(ParseConstants.KEY_FILE_TYPE).equals(ParseConstants.TYPE_PHOTO)) {
            holder.iconImageView.setImageResource(R.drawable.ic_list_picture);
        } else {
            holder.iconImageView.setImageResource(R.drawable.ic_list_play_over_video);
        }
